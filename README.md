...
> **This is a tutorial fork of [chrishayuk/larql](https://github.com/chrishayuk/larql)** with comprehensive, deep-dive onboarding documentation explaining the technologies behind LARQL.
>
> **New to LARQL?** Start with the [Tutorial Documentation](TUTORIAL.md) which explains transformers, FFN layers, gate KNN, and WalkFfn from first principles with code cross-references.
...
### Tutorial Documentation (Added in This Fork)

| Doc | Description |
|---|---|
| **[TUTORIAL.md](TUTORIAL.md)** | **Start here** - Index of all tutorial documentation |
| [How It Works](docs/overview/how-it-works.md) | Deep technical dive - transformers, FFN, gate KNN with code references |
| [What is LARQL?](docs/overview/what-is-this.md) | Mental model and core concepts |
| [Quickstart](docs/getting-started/quickstart.md) | 15-minute hands-on guide |
| [System Design](docs/architecture/system-design.md) | Crate architecture, data flows, ADRs |
